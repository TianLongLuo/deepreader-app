...
Include who_did_what items with actor, action, target; explain omitted subjects as inference without inventing a source span. Include tone_or_subtext, reading_tip and a full translation in the requested explanation language. Populate logic_flow with step, text, relation, explanation when there is a meaningful progression, rather than repeating sentence summaries. Explain reference_map antecedents, clearly indicating unresolved references.
